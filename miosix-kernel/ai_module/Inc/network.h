...
#define AI_NETWORK_IN	AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 50, 12, 1, 1, NULL)
#define AI_NETWORK_IN_SIZE (50 * 12 * 1)
#define AI_NETWORK_IN_1_SIZE  (50 * 12 * 1)
#define AI_NETWORK_IN_1_SIZE_BYTES  ((50 * 12 * 1) * 4)


#define AI_NETWORK_OUT_NUM      (1)
#define AI_NETWORK_OUT	AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 4, 1, NULL)
