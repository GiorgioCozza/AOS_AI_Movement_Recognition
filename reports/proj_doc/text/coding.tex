...
Before proceeding to read data from MEMS, it is required to configure the control registers. Activation and initialization are performed in a single step implemented by \mintinline[bgcolor=whitesmoke]{C++}{init()}. It runs similarly for both LSM6DSL and LSM303AGR
