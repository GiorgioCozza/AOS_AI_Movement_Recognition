...
A final and simple solution to the mentioned problems relies on a simple Raspberry Pi Model 3 besides the board all supplied by a battery:
\begin{center}
	\begin{figure}[H]
		\begin{subfigure}[H]{0.45\textwidth}
